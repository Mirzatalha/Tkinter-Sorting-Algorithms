...
def show_button_to_forget(ll1, ll2, ll3, ee1, ee2, ee3, my_button1):
    ...
    # clear_button = Button(master, text="Clear", bg='#FDA023', height=2, font=("Franklin", 12),
    #                       fg='white', width=20, command=lambda: clear_fn(arr_heap, arr_count, arr_insert, arr_quick))
